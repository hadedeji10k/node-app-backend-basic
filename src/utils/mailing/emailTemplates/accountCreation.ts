...
export const accountCreationTemplate = ({ context }: Pick<EmailOptions, 'context'>) => `
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Streamvest - Account created</title>
  ...
  <body>
    <div class="main">
      ...
      <section>
        <h1 class="title">Welcome to Streamvest, ${context.name}</h1>
        <p class="subtitle">Glad to have you on board 🥳.</p>
        <h1 class="title">Confirm Your Registration</h1>
      </section>
      <main>
        <p>
            Please use the activation code below:
        </p>
        ...
        <p>
          ...
          or send us an email <b>support@streamvest.com</b>
        </p>
      </main>
      <hr class="line" />
      <footer>
