...
export const userForgetPasswordTemplate = ({ context }: Pick<EmailOptions, 'context'>) => `
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <div class="main">
      ...
      <hr class="line" />
      <section>
          <h1 class="title">Forgot your password ${context.name}?</h1>
      </section>
      <main>
          <p>
          ...
          <p>
              Once password is reset, you'll be able to log into the Streamvest mobile app.
          </p>
      </main>
      <hr class="line" />
      <footer>
