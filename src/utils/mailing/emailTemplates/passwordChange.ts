...
export const passwordChangeTemplate = ({ context }: Pick<EmailOptions, 'context'>) => `
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <div class="main">
      ...
      <main>
        ...
        <p>
            You are receiving this email because someone has change your password for your Streamvest account.
    
            If you feel this was an error please contact <b>Streamvest Team</b> immediately
        </p>
      </main>
      <hr class="line" />
      <footer>
